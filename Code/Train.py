...
def GenerateBatch(BasePath, DirNamesTrain, TrainLabels, ImageSize, MiniBatchSize):
    ...
    while ImageNum < MiniBatchSize:
        ...
        # if we want to add horizontal flip
...
def TrainOperation(ImgPH, LabelPH, DirNamesTrain, TrainLabels, NumTrainSamples, ImageSize,
                   ...
                   DivTrain, LatestFile, BasePath, LogsPath, ExpName):
    """
    Inputs: 
    ...
    prLogits, prSoftMax = ImprovedModel(ImgPH, ImageSize, MiniBatchSize)
    ...
    with tf.Session() as sess:       
        ...
        for Epochs in tqdm(range(StartEpoch, NumEpochs)):
            ...
            for PerEpochCounter in tqdm(range(NumIterationsPerEpoch)):
                ...
                Batch_loss = Batch_loss + LossThisBatch
            ...
            # Save Accuracy and Loss of each epoch
            epoch_loss_list.append(Batch_loss / NumIterationsPerEpoch)
            epoch_acc_list.append(acc)
            print("\n")
            print("Epoch Loss" + str(epoch_loss_list))
            print("Epoch Accuracy" + str(epoch_acc_list))
            np.save(ExpName + '_loss.npy', np.array(epoch_loss_list))
            np.save(ExpName + '_train_accuracy.npy', np.array(epoch_acc_list))
...
def main():
    ...
    Parser.add_argument('--ExpName', dest='ExpName', default='CIFAR10Model', help='Name of Experiment')
    Parser.add_argument('--BasePath', default='/scratch0/CMSC733/YourDirectoryID_hw0/Phase2/CIFAR10', help='Base path of images, Default:/scratch0/CMSC733/YourDirectoryID_hw0/Phase2/CIFAR10')
